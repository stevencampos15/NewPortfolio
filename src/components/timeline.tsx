            ...
            {timelineData.map((item: TimelineItem, index: number) => (
              ...
              >
                ...
                <div className={`w-4/5 md:w-[calc(50%-1rem)] pt-6 md:pt-0 relative z-10 ${
                  ...
                  <div className="bg-black text-white dark:bg-[#2A2A2A] p-5 md:p-4 rounded-lg border border-[#9CB7C9]/20 shadow">
                    ...
                    <p className="text-foreground/70 dark:text-gray-400 text-base md:text-sm mb-3">{item.description}</p>
